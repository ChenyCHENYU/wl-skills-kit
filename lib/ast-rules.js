 ...
 *
 * 规则编号 K1~K19 对应 standards 02/04/05/06/07/09/10/11/12/13 中的语义约束：
...
function createPageContext(targetDir, page, shared) {
  ...
  return { ...shared, page, absDir, dataContent,
...
function inspectAstPages(targetDir, pages, shared, cacheState) {
  ...
  for (const page of pages) {
    if (!includesStagedPage(cacheState.stagedFilter, page.dir)) continue;
